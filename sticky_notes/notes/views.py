...
from django.urls import reverse_lazy # Used for redirecting after form submission
from .models import Note
from .forms import NoteForm # Import the form we just created
...
class NoteUpdateView(generic.UpdateView):
    ...
    success_url = reverse_lazy('note_list') # Or reverse_lazy('note_detail', args=[self.object.pk]) if you want to go to detail
